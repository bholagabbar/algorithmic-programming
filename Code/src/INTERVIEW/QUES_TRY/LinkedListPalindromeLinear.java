...
//Solution: If the length is odd, remove the middle node
//After that split the list into two and reverse one of the two parts
//Now compare the values of the lists
//Solution is O(n) time, O(1) space and can be regenerated

class LinkedListPalindromeLinear {
