...
class MeetingRooms {
    ...
    public static int minMeetingRooms(Interval[] intervals) {
        ...
        PriorityQueue<Interval> pq = new PriorityQueue<>(intervals.length, (o1, o2) -> Integer.compare(o1.end, o2.end));
        pq.add(intervals[0]);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int ans = minMeetingRooms(new Interval[]{new Interval(2, 11), new Interval(6, 16), new Interval(11, 16)});
