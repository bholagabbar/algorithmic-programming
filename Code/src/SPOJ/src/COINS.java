...
/**
 * Created by Shreyans Sheth [bholagabbar] on 10/31/2015 at 6:14 PM using IntelliJ IDEA (Fast IO Template)
 */
...
class COINS
{
    ...
    static long getMax(long n)
    {
        ...
        if(!memo.containsKey(n))
            memo.put(n,Math.max(n,getMax(n/4)+getMax(n/3)+getMax(n/2)));
        return memo.get(n);
    }
