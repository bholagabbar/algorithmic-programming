// BEGIN CUT HERE
// PROBLEM STATEMENT
// Given an int n find all positive integers less than n 
// whose digits are all different. Return the total number of 
// such integers.
// 
// DEFINITION
// Class:UniqueDigits
