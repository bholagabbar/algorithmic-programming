package CODECHEF.LONG_CHALLENGE.APRIL15.src;import java.io.*;
import java.util.InputMismatchException;

/**
 * Created by Shreyans on 4/7/2015 at 5:35 PM using IntelliJ IDEA (Fast IO Template)
 */

class FRMQ
{
    static int a[]=new int[100001];
    static int st[]=new int[10001*4];
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        for(int i=0;i<m;i++)
        {
            ans+=RMaxQ(1,0,n-1,Math.min(x,y),Math.max(x,y));
            x=(x+7)%(n-1);
            y=(y+11)%(n);
        }
        out.printLine(ans);
