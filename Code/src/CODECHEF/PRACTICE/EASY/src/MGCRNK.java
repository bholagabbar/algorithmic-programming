...
/**
 * Created by Shreyans Sheth [bholagabbar] on 6/23/2015 at 11:55 AM using IntelliJ IDEA (Fast IO Template)
 */
...
class MGCRNK {
	public static void main(String[] args) throws Exception {
		...
		while (tc-- > 0) {
			...
			for (int i = 0; i <= n; i++) {
				dp[0][i] = dp[i][0] = Integer.MIN_VALUE;
			}
			dp[0][1] = dp[1][0] = 0;
			...
			//PATHS ARE CONSTANT!!!
			double ans = dp[n][n] / ((double) (2 * n - 3));
