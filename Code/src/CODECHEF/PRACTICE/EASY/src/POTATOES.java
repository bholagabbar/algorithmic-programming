...
/**
 * Created by Shreyans on 1/31/2015 at 3:23 PM using IntelliJ IDEA (Fast IO Template)
 */
...
class POTATOES {
	...
	public static boolean[] SOE(int m) {
		int max = m;
