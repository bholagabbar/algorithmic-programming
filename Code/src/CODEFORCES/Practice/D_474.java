...
/**
 * Created by Shreyans Sheth [bholagabbar] on 10/12/2015 at 9:38 PM using IntelliJ IDEA (Fast IO Template)
 */
...
public class D_474
{
    public static void main(String[] args) throws Exception
    {
        ...
        while(t-->0)
        {
            ...
            out.printLine(((sum[b]-sum[a-1])+MOD)%MOD);
