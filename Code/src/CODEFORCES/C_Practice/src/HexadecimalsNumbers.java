...
/**
 * Created by Shreyans Sheth [bholagabbar] on 12/16/2015 at 10:59 PM using IntelliJ IDEA (Fast IO Template)
 */

public class HexadecimalsNumbers {
	public static void main(String[] args) throws Exception {
		...
		ts.add((int) 1e9);
		out.printLine(ts.subSet(0, n + 1).size());
	}
