...
/**
 * Created by Shreyans Sheth [bholagabbar] on 12/9/2015 at 4:46 PM using IntelliJ IDEA (Fast IO Template)
 */
...
public class Team_401 {
	public static void main(String[] args) throws Exception {
		...
		int zeros = in.readInt(), ones = in.readInt();
		if (zeros >= ((ones + 1) / 2) - 1 && zeros <= ones) {
