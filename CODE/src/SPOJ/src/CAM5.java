...
/**
 * Created by Shreyans Sheth [bholagabbar] on 9/16/2015 at 9:26 PM using IntelliJ IDEA (Fast IO Template)
 */
...
class CAM5
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        while(tc-->0)
        {
            ...
            out.printLine(ConnectedComponents(n));
        }
    }
